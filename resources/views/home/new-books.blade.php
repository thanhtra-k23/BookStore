...
<style>
    ...
    .book-card-modern .book-title a {
        color: inherit;
        text-decoration: none;
    }

    .book-card-modern .book-title a:hover {
        color: #10b981;
    }
    ...
    .book-card-modern .price-current {
        font-size: 1.1rem;
        font-weight: 700;
        color: #dc2626;
    }

    .book-card-modern .price-old {
        font-size: 0.75rem;
        color: #94a3b8;
...
<div class="page-hero">
    <div class="container">
        <div class="page-hero-content">
            ...
            <h1 class="page-title">Sách mới nhất</h1>
            <p class="page-desc">Khám phá những đầu sách mới nhất vừa được cập nhật tại BookStore</p>
        </div>
    </div>
</div>
...
<div class="container" style="padding-top: 1.5rem;">
    ...
    <div class="filter-bar">
        <p class="result-count">
            Tìm thấy <span>{{ $books->total() }}</span> cuốn sách mới
        </p>
        
        <form method="GET" action="{{ route('new-books') }}">
    ...
    @else
        <div class="empty-state">
            ...
            <p>Vui lòng quay lại sau để xem sách mới nhất</p>
