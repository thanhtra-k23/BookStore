                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('ten_ma_giam_gia') is-invalid @enderror" 
                                           id="ten_ma_giam_gia" name="ten_ma_giam_gia" value="{{ old('ten_ma_giam_gia') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('ma_code') is-invalid @enderror" 
                                               id="ma_code" name="ma_code" value="{{ old('ma_code') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('loai_giam_gia') is-invalid @enderror" 
                                        ...
                                        <option value="so_tien" {{ old('loai_giam_gia') == 'so_tien' ? 'selected' : '' }}>Số tiền (VNĐ)</option>
                                    </select>
                                    @error('loai_giam_gia')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('gia_tri_giam') is-invalid @enderror" 
                                           id="gia_tri_giam" name="gia_tri_giam" value="{{ old('gia_tri_giam') }}" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('gia_tri_don_hang_toi_thieu') is-invalid @enderror" 
                                           ...
                                           value="{{ old('gia_tri_don_hang_toi_thieu', 0) }}" min="0" step="0.01" required>
                                    @error('gia_tri_don_hang_toi_thieu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            </div>
                            <div class="col-md-6" id="max-discount-group" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('gia_tri_giam_toi_da') is-invalid @enderror" 
                                           ...
                                           value="{{ old('gia_tri_giam_toi_da') }}" min="0" step="0.01">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('so_luong') is-invalid @enderror" 
                                           id="so_luong" name="so_luong" value="{{ old('so_luong') }}" min="1">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('gioi_han_su_dung_moi_user') is-invalid @enderror" 
                                           ...
                                           value="{{ old('gioi_han_su_dung_moi_user', 1) }}" min="1">
