                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['with_books'] }}</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['without_books'] }}</div>
                        </div>
                        <div class="col-auto">
                        ...
                        <tbody>
                            @foreach($nhaXuatBan as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if($item->quoc_gia)
                                            <span class="badge bg-info">{{ $item->quoc_gia }}</span>
                                        @else
...
function bulkAction(action) {
    ...
    switch (action) {
        case 'delete':
            title = 'Xác nhận xóa';
            text = `Bạn có chắc chắn muốn xóa ${selectedIds.length} nhà xuất bản đã chọn?`;
            confirmButtonText = 'Xóa';
            break;
        case 'activate':
            title = 'Xác nhận kích hoạt';
            text = `Bạn có chắc chắn muốn kích hoạt ${selectedIds.length} nhà xuất bản đã chọn?`;
            confirmButtonText = 'Kích hoạt';
            break;
        case 'deactivate':
            title = 'Xác nhận vô hiệu hóa';
            text = `Bạn có chắc chắn muốn vô hiệu hóa ${selectedIds.length} nhà xuất bản đã chọn?`;
